...
|---------|----------|------------|
| **Pub/Sub** | Continuous data streaming, sensor data, status updates | [Pub/Sub](./core-concepts/pubsub.md) |
| **Services** | Request-response operations, remote procedure calls | [Services](./core-concepts/services.md) |
| **Actions** | Long-running tasks with feedback and cancellation support | [Actions](./core-concepts/actions.md) |
...
**Ready to build safer, faster robotics applications? Start with the [Quick Start Guide](./getting-started/quick-start.md).**
