...
use crate::msg::{CdrSerdes, ZSerdes};
...
fn test_static_point_to_dynamic() {
    ...
    let cdr_bytes = CdrSerdes::serialize_to_vec(&static_msg);
...
fn test_dynamic_point_to_static() {
    ...
    let static_msg = <CdrSerdes as ZSerdes<Point>>::deserialize(&cdr_bytes).unwrap();
...
fn test_dynamic_string_to_static() {
    ...
    // Deserialize as static message
    let static_msg = <CdrSerdes as ZSerdes<StdString>>::deserialize(&cdr_bytes).unwrap();
...
fn test_dynamic_twist_to_static() {
    ...
    // Deserialize as static message
    let static_msg = <CdrSerdes as ZSerdes<Twist>>::deserialize(&cdr_bytes).unwrap();
...
fn test_roundtrip_static_dynamic_static() {
    ...
    let recovered = <CdrSerdes as ZSerdes<Point>>::deserialize(&cdr_bytes2).unwrap();
...
fn test_roundtrip_dynamic_static_dynamic() {
    ...
    // Static → CDR → Dynamic
    let cdr_bytes2 = CdrSerdes::serialize_to_vec(&static_msg);
...
fn test_cdr_bytes_identical() {
    ...
    let static_bytes = CdrSerdes::serialize_to_vec(&static_msg);
