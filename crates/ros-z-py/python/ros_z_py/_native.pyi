"""Type stubs for the ros-z-py native Rust extension (_native.abi3.so)."""
...
# ---------------------------------------------------------------------------
# QoS constants (dict form for backward compatibility)
# ---------------------------------------------------------------------------

QOS_DEFAULT: dict[str, object]
QOS_SENSOR_DATA: dict[str, object]
QOS_PARAMETERS: dict[str, object]
QOS_SERVICES: dict[str, object]
